...
const (
	...
	AgentServiceName = "sumi.agent.v1.AgentService"
)
...
const (
	...
	AgentServiceListAgentsProcedure = "/sumi.agent.v1.AgentService/ListAgents"
)
...
// NewAgentServiceClient constructs a client for the sumi.agent.v1.AgentService service. By default,
...
func NewAgentServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AgentServiceClient {
	...
	agentServiceMethods := v1.File_sumi_agent_v1_agent_proto.Services().ByName("AgentService").Methods()
...
// ListAgents calls sumi.agent.v1.AgentService.ListAgents.
...
func NewAgentServiceHandler(svc AgentServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/sumi.agent.v1.AgentService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAgentServiceHandler) GetAgent(context.Context, *connect.Request[v1.GetAgentRequest]) (*connect.Response[v1.GetAgentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sumi.agent.v1.AgentService.GetAgent is not implemented"))
}
...
func (UnimplementedAgentServiceHandler) ListAgents(context.Context, *connect.Request[v1.ListAgentsRequest]) (*connect.Response[v1.ListAgentsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sumi.agent.v1.AgentService.ListAgents is not implemented"))
}
