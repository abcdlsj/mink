...
func (s *State) CompleteMutation(ctx context.Context, requestID string, status MutationStatus, responseLaunchID string, responseFence uint64, responseExpiresAt *time.Time, completedAt time.Time) error {
