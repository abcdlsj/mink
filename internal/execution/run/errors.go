...
func runErr(err error) error {
	...
	case errors.Is(err, executionapp.ErrRunNotFound),
		errors.Is(err, collaborationapp.ErrSpaceNotFound),
		errors.Is(err, collaborationapp.ErrThreadNotFound):
		return connect.NewError(connect.CodeNotFound, err)
	case errors.Is(err, executionapp.ErrRunRequestConflict),
		errors.Is(err, executionapp.ErrRunCompletionConflict):
		return connect.NewError(connect.CodeAlreadyExists, err)
	case errors.Is(err, executionapp.ErrRunNotQueued),
		errors.Is(err, executionapp.ErrRunNotRunning),
		errors.Is(err, executionapp.ErrRunLeaseActive),
	...
	case errors.Is(err, executionapp.ErrInvalidRunLimit),
		errors.Is(err, executionapp.ErrRunInvalidOutcome),
