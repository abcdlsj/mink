  ...
  return (
    <section className="task-detail" aria-labelledby="task-heading">
      <header className="task-detail-header">
        <div className="page-title"><h1 id="task-heading">{value.title}</h1><p>{threadAddressLabel(value.source_thread)} · message {value.source_thread.root_message_seq}</p></div>
